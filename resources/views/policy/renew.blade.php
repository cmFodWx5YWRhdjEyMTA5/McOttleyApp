            ...
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class=""> Policy Administration </li>
                 <li class="active"> Renew Policy </li>   
              </ul>
              ...
              <div class="row">
                ...
                <form method="post" data-validate="parsley" action="/renew-policy" class="panel-body wrapper-lg">
                        ...
                        <option value="{{ $customer->id }}">{{ $customer->fullname }}</option>
                         ...
                         <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('policy_number') ? ' has-error' : ''}}">
                            ...
                            <input id="policy_number" name="policy_number" readonly="true" class="form-control" rows="3" tabindex="1" value="{{ $policy->policy_number }}" data-required="true">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('policy_type') ? ' has-error' : ''}}">
                            ...
                            <select id="policy_type" name="policy_type" rows="3" tabindex="1" data-placeholder="Select here.." class="form-control m-b" onchange="loadInsurer(),loadinsurancetype()" data-required="true">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-sm-4">
                         ...
                         <option value="{{ $fetchrecord->vehicle_currency }}">{{ $fetchrecord->vehicle_currency }}</option>
                         @foreach($currencies as $currency)
                        <option value="{{ $currency->type }}">{{ $currency->type }}</option>
                          @endforeach
                        </select> 
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" class="form-control" id="vehicle_value"  value="{{ $fetchrecord->vehicle_value }}"  name="vehicle_value">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" class="form-control" id="vehicle_tppdl_value"  value="{{ $fetchrecord->vehicle_tppdl_value }}"  name="vehicle_tppdl_value">
                        ...
                        <option value="{{ $year }}">{{ $year }}</option>
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="number" class="form-control" id="vehicle_seating_capacity"  value="{{ $fetchrecord->vehicle_seating_capacity }}"  name="vehicle_seating_capacity">
                        ...
                        <div class="form-group pull-in clearfix">
                           ...
                           <input type="number" class="form-control" id="vehicle_cubic_capacity"  value="{{ $fetchrecord->vehicle_cubic_capacity }}"  name="vehicle_cubic_capacity">
                          ...
                          <div class="col-sm-4">
                           ...
                           <input type="text" class="form-control" id="vehicle_registration_number"  value="{{ $fetchrecord->vehicle_registration_number }}"  name="vehicle_registration_number">
                    ...
                    <div id="motorinsurancecomprehensive" name="motorinsurancecomprehensive">
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                          ...
                          <option value="{{ $fetchrecord->vehicle_interest_status }}">{{ $fetchrecord->vehicle_interest_status }}</option>
                        ...
                        <div class="col-sm-12">
                         ...
                         <textarea type="text" rows="3" class="form-control" id="vehicle_interest_name" name="vehicle_interest_name" value="">{{  $fetchrecord->vehicle_interest_name }}</textarea> 
                         ...
                         <option value="{{ $fetchrecord->vehicle_declined_status }}">{{ $fetchrecord->vehicle_declined_status }}</option>
                        <option value="Yes">Yes</option>
                         <option value="Yes">No</option>
                        </select>         
                        ...
                        <div class="col-sm-12">
                         ...
                         <textarea type="text" rows="3" class="form-control" id="vehicle_declined_reason" name="vehicle_declined_reason" value="">{{ $fetchrecord->vehicle_declined_reason }}</textarea> 
                     ...
                     <div class="form-group pull-in clearfix">
                        ...
                        <option value="{{ $fetchrecord->vehicle_cancelled_status }}">{{ $fetchrecord->vehicle_cancelled_status }}</option>
                        <option value="Yes">Yes</option>
                         <option value="Yes">No</option>
                        </select>         
                        ...
                        <div class="col-sm-12">
                         ...
                         <textarea type="text" rows="3" class="form-control" id="vehicle_cancelled_reason" name="vehicle_cancelled_reason" value="">{{ $fetchrecord->vehicle_cancelled_reason }}</textarea> 
                      ...
                      <section class="panel panel-default">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('gross_premium') ? ' has-error' : ''}}">
                            ...
                            <input type="text" class="form-control parsley-validated" id="gross_premium"  value="{{ $bills->amount }}" data-type="number" name="gross_premium"><span class="input-group-addon">.00</span>   
                            </div>      
                          ...
                          <div class="form-group{{ $errors->has('commission_rate') ? ' has-error' : ''}}">
                            ...
                            <input type="text" class="form-control parsley-validated" id="commission_rate"  value="{{ $bills->commission_rate }}" data-type="number"   name="commission_rate">         
                          ...
                          <div class="form-group{{ $errors->has('collection_mode') ? ' has-error' : ''}}">
                            ...
                            <select id="collection_mode" name="collection_mode" rows="3" tabindex="1" data-placeholder="Select here.." class="form-control m-b">
                             <option value="{{ $bills->note }}">{{ $bills->note }}</option>
                        ...
                        <div class="btn-group pull-right">
                        <button type="submit" onclick="fillmandatory()" class="btn btn-rounded btn-sm btn-info">Renew Policy</button>
                        <input type="hidden" name="_token" value="{{ Session::token() }}">
                         ...
                         <input type="hidden" name="detailid" id="detailid" value="{{ $fetchrecord->id }}">
                          <input type="hidden" name="refid" id="refid" value="{{ $policy->ref_number }}">
                        </div>
