                     ...
                     <div class="clearfix m-b">
                        ...
                        <div class="form-group pull-in clearfix">
                          ...
                          <div class="form-group{{ $errors->has('account_type') ? ' has-error' : ''}}">
                            ...
                            <select id="account_type" name="account_type" data-required="true" rows="3" tabindex="1" data-placeholder="Select here.." class="form-control m-b">
                        ...
                        <div class="form-group">
                         <div class="form-group{{ $errors->has('fullname') ? ' has-error' : ''}} {!! $errors->has('first_name') ? 'has-error' : '' !!}">
                          <label>Name </label>
                          <input type="text" class="form-control" id="fullname" value="{{ Request::old('fullname') ?: '' }}"  name="fullname" data-required="true">
                        ...
                        <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : ''}}">
                          <label>Date of Birth / Date of Incoporation </label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" data-required="true" id="mobile_number" name="mobile_number" value="{{ Request::old('mobile_number') ?: '' }}">   
