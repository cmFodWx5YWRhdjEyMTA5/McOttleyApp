            ...
            <section class="scrollable">
              <section class="hbox stretch">
                  ...
                  <form class="form-horizontal" method="get">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" readonly="true" value="{{ $claims->fullname }}" class="form-control rounded">                        
                      </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                  ...
                  <form class="form-horizontal" method="get">
                    ...
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" readonly="true" value="{{ $claims->policy_product }}" class="form-control rounded">                        
                      </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" readonly="true" value="{{ $claims->insurance_period_from }}" class="form-control rounded">                        
                      </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" method="get">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Insurer Contact Name</label>
                      <div class="col-sm-10">
                    ...
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                      <label class="col-sm-2 control-label">Insurer Contact Email</label>
                      <div class="col-sm-10">
                        <input type="text" readonly="true" value="{{ $claims->insurer_contact_email }}" class="form-control rounded">                        
                      </div>
                    </div>
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                      <label class="col-sm-2 control-label">Insurer Contact Phone</label>
                      <div class="col-sm-10">
