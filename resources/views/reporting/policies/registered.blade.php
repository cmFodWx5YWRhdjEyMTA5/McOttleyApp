          ...
          <section class="vbox">          
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li >Reports</li>
                <li class="active">Registered policies report</li>
              </ul>
            
              <div class="col-lg-12">
                  <h2 class="font-thin">Registered policies report</h2>
                </div>
               ...
               <section class="panel panel-default">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" method="get">
                    ...
                    <div class="line line-dashed line-lg pull-in"></div>
                     <div class="form-group">
                      <label class="col-sm-2 control-label">POLICY COLLECTION</label>
                      <div class="col-sm-10">
                        <input type="text" readonly="true" value="" class="form-control rounded">                        
                      </div>
                    </div>
