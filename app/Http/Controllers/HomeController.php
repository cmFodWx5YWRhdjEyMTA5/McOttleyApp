...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $endingpolicies =  ProcessedPolicy::limit(5)->orderBy('created_on','desc')->get();
        $bills          =  Bill::where('status','Unpaid')->orderBy('created_on','desc')->limit(5)->get();
        $paidbills          =  Bill::where('status','Paid')->orderBy('created_on','desc')->get();
        ...
        return View('pages.dashboard', compact('getactivities','processedpolicies','paidbills','customercount','events','customers','visits','bills','endingpolicies'));
    }
